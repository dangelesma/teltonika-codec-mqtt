                ...
                <div class="flex items-center justify-between">
                  <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-3 mb-2">
                      <div id="mqtt-status-indicator" class="w-3 h-3 rounded-full bg-gray-500 shadow-lg flex-shrink-0"></div>
                  ...
                  <button id="mqtt-reconnect-btn" class="ml-3 px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 rounded-xl text-sm font-medium transition-all shadow-lg shadow-cyan-500/20 flex-shrink-0">
                    Reconnect
                  </button>
                </div>
              </div>
